                ...
                <form onSubmit={handleSubmit} style={{
                    ...
                    <div style={{ marginBottom: '1.5rem' }}>
                        ...
                        <textarea
                            ...
                            onFocus={(e) => e.target.style.borderColor = '#6366f1'}
                            onBlur={(e) => e.target.style.borderColor = '#d1d5db'}
                            placeholder="Provide context for the resource..."
                        />
                    </div>

                    {/* Teachings Field */}
                    <div style={{ marginBottom: '1.5rem' }}>
                        <label htmlFor="teachings" style={{ 
                            display: 'block',
                            fontSize: '1rem',
                            fontWeight: '600',
                            color: '#222222',
                        ...
                        <input
                            ...
                            onFocus={(e) => e.target.style.borderColor = '#6366f1'}
                            onBlur={(e) => e.target.style.borderColor = '#d1d5db'}
                            placeholder="Summarize what this resource teaches..."
                        />
                    </div>
                    ...
                    <div style={{ marginBottom: '1.5rem' }}>
                        ...
                        <input
                            ...
                            onFocus={(e) => e.target.style.borderColor = '#6366f1'}
                            onBlur={(e) => e.target.style.borderColor = '#d1d5db'}
                            placeholder="Enter the URL for the resource..."
                        />
                    </div>
